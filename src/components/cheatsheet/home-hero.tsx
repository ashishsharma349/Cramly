...
export function HomeHero({ onCreateClick }: { onCreateClick: () => void }) {
  return (
    <section className="relative rounded-2xl border border-border bg-gradient-to-br from-background via-secondary/30 to-primary/5 overflow-hidden p-8 lg:p-12">
        ...
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <p className="text-base text-muted-foreground max-w-md">
              Generate concise, well-structured cheat sheets for any topic with Cramly. Save time, boost productivity, and ace your learning.
            </p>
          </div>

          {/* Buttons */}
          <div className="flex flex-col sm:flex-row gap-3">
            <Button size="lg" className="rounded-lg gap-2" onClick={onCreateClick}>
